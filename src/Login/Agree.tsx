      ...
      <View style={styles.container}>
        ...
        <View style={{flex:2}}> 
          ...
          <View style={styles.allCheckbox}>
            ...
            <View>
              <Typography fontSize={14}>이로운팜플렛 이용약관 전체 동의</Typography>
