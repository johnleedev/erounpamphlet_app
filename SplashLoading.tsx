...
import { ImageBackground, Alert, Linking, Platform } from "react-native";
...
export default function SplashLoading (props: any) {
  ...
  //           { text: '업데이트', onPress: ()=>{
  //             if (Platform.OS === 'ios') {
  //               Linking.openURL('https://apps.apple.com/kr/app/%EC%84%B1%EC%95%85%ED%95%98%EB%8A%94%EB%8C%80%ED%95%99%EC%83%9D%EB%93%A4/id6451302745');
  //             } else {
  //               Linking.openURL('https://play.google.com/store/apps/details?id=com.studentsclassic.app');
  //             }
  //           }},
  //         ]
  //       );
